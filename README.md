...
The project reflects real-world engineering workflows, including collaborative version control, modular development, and deployment pipelines.

---

## ✨ Key Features

- **Dynamic Data Rendering** - Integration with an external API to fetch and display planetary data in real time
- **Component-Based Architecture** - Reusable and well-structured React components for scalability and separation of concerns
- **Responsive Design** - Fully optimized UI across mobile, tablet, and desktop devices using modern CSS techniques
- **Interactive UI Sections** - Hero section, data tables, media content, image galleries, and user input forms
- **Team Collaboration Workflow** - Structured Git workflow with branching strategies, pull requests, and code reviews
...
👉 **[View Live Application](https://ts-academy-react-project-hy1d.vercel.app/)**
